...
class CreateDenounceProcedures extends Migration
{
    public function up()
    {
        // --- Procedimiento: usp_findDenounceForPDFById --- (VERSIÓN UNIVERSAL COMPATIBLE)
        ...
        BEGIN
            ...
            WHERE d.id = p_id
            GROUP BY 
                d.id, d.code, d.reception_media, d.date, d.has_previous_denounce, d.has_response, d.directed_entity,
                d.entity_response, d.comunication_media, d.source, d.keep_identity,
                P1.is_natural_person, P1.doc_number, P1.name, P1.paternal_surname, P1.mother_surname,
                P1.trade_name, P1.legal_representator, P1.address, P1.fixed_phone, P1.first_phone,
                P1.second_phone, P1.email,
                P2.is_natural_person, P2.doc_number, P2.name, P2.paternal_surname, P2.mother_surname,
                P2.trade_name, P2.legal_representator, P2.address, P2.fixed_phone, P2.first_phone,
                d.address, d.reference, d.facts_description, d.ambiental_promise, d.proof_description;
        END
        SQL;
        $this->db->query($sql1);
